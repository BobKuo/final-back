...
import { uploadImgs, uploadOne } from '../middlewares/upload.js'

const router = Router()

router.post('/add', auth.token, auth.admin, uploadOne, series.create)
...
router.patch('/:id', auth.token, auth.admin, uploadOne, series.update)
